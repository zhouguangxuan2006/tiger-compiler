...
RUN apt clean
RUN apt update && apt install -y sudo git cmake g++ gcc vim tar gdb flexc++ bisonc++ openssh-server rsync python3.8 python3-pip dos2unix clang-format-10 zip unzip
